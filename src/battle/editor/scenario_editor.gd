...
func update_background_gradient(_new_color: Color = Color.BLACK) -> void:
	...
	# Not written straight onto the TextureRect any more: there are TWO renderers for
	# this gradient now (the 2D one and the 3D quad the effects addon drives), and
